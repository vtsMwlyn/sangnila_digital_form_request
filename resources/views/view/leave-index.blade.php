...
@section ('content')
  ...
  <div
    class="container-draft bg-[#FEFEFEB2] p-4 sm:p-6 rounded-2xl w-full shadow-lg overflow-x-auto"
  >
        ...
        <tbody>
          @forelse ($data as $d)
            ...
            <tr class="{{ $loop->odd ? 'bg-white' : '' }}">
              ...
              @endif
              <td>
                {{ Carbon\Carbon::parse($d->start_leave)->format('d M Y') }}
              </td>
            ...
            >
              <div>
                ...
                <div class="flex text-sm text-gray-500">
                  {{ Carbon\Carbon::parse($d->start_leave ?? $d->overtime_date)->format('d F Y') }} — {{ $duration }}
                </div>
