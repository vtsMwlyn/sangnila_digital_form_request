    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-10 mt-5">
      ...
      <div class="flex-1">
        ...
        <div id="media-preview" class="mt-12 hidden">
          ...
          <div
            id="preview-images-existing"
            class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-2 w-full"
          ></div>
          <div
            id="preview-images-new"
            class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-2 w-full"
          ></div>

          <div
            id="preview-videos-existing"
            class="grid grid-cols-1 xl:grid-cols-2 gap-6 w-full"
          ></div>
          <div
            id="preview-videos-new"
            class="grid grid-cols-1 xl:grid-cols-2 gap-6 w-full"
          ></div>
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col w-full">
        <h3 class="text-blue-800 font-extrabold text-lg xl:mt-0 mt-2">
        ...
        <div class="mt-4 grid grid-cols-1 xl:grid-cols-2 gap-5">
          <div class="pl-2">
            ...
            <x-text-input
              ...
              id="photo-input"
              accept="image/*"
              class="w-full py-20 px-10 border-4 rounded-xl border-slate-400 border-dashed bg-white"
            />
            @error ('photo')
        ...
        <span class="text-slate-600 italic mt-10"
          >By submitting, you confirm that all provided information is accurate
          and you acknowledge that
          <b>any false or invalid data may result in consequences</b>.</span
        >
        ...
        <div class="w-full flex justify-end mt-4">
          <div class="w-full xl:w-2/3 gap-2 grid grid-cols-2 mt-6">
            ...
            <x-button type="submit" name="action" value="submit" class="w-full">
      ...
      <button
        @click="
          window.dispatchEvent(
            new CustomEvent('close-modal', { detail: 'evidence-viewer-modal' }),
          )
        "
