...
@endphp
  <div class="container-draft bg-[#FEFEFEB2] p-6 rounded-2xl w-full shadow-lg">
    <x-form-filter-all-data
      title="My Request Drafts"
      route="draft"
      :status="$requestStatus"
      :type="$requestType"
    />

    <table class="min-w-full text-left justify-center">
      ...
      <tbody>
        @forelse ($data as $d)
          <tr class="{{ $loop->odd ? 'bg-white' : '' }}">
            ...
            <td
              class="py-4 px-6"
              title="{{ $d->task_description ?? $d->reason }}"
            >
            ...
            <td class="py-4 px-6 text-center">
              <div class="flex space-x-2">
                ...
                <a href="{{ route('overtime.edit', $d->id) }}" title="Edit">
                  <img
              ...
              <div class="flex flex-col items-center">
                @if ($requestType === 'overtime')
                  ...
                  <a
                    ...
                    class="text-[#1EB8CD] hover:underline mt-2"
                  >
