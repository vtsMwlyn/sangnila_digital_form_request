      ...
      <div class="flex-1 flex flex-col xl:space-y-4">
        ...
        <div class="flex flex-col w-full">
          <div class="rangeTime flex flex-col w-full">
            <x-input-label for="startDate" class="font-bold text-md mb-1">
        ...
        <div class="flex flex-col mt-3">
          ...
          <div class="flex flex-row h-10">
            ...
            <span
              id="daysLabel"
              class="text-gray-500 mt-2 ml-2 text-xs xl:text-lg"
            >
              @if (isset($leave))
                {{ old('many_days',
                            $labelNumeric) }}
        ...
        <div class="flex flex-col mt-3">
          <div class="rangeTime flex w-full">
            <x-input-label for="manyHour" class="font-bold text-md mb-1">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      fetch("/leave_allowance", {
        ...
        .then((data) => {
          let allowance = {{ max(Auth::user()->leave_balance, Auth::user()->overtime_balance) }};
          ...
          manyDays.addEventListener("input", function () {
            ...
            } else if (decimal == 0.5 && numericDecimal > 1) {
