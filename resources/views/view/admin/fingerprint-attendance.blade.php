...
@section ('content')
  <section
    class="mx-1 container-draft bg-[#F0F3F8] p-6 rounded-2xl w-full shadow-lg overflow-x-auto"
  >
  ...
  <script>
    $(document).ready(function () {
      ...
      // ===== PRELOAD HOLIDAYS =====
      fetchGoogleHolidays(formatInputDate(startDate), formatInputDate(endDate));
      ...
      $submitBtn.on("click", function (e) {
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            const mergedEvents = [...holidayEvents, ...attendanceEvents];
