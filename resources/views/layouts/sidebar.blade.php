...
<div class="hidden sm:flex flex-wrap justify-end w-full md:w-auto">
    ...
    <aside
        id="desktop-sidebar"
        class="sidebar fixed top-0 left-0 h-full w-72 translate-x-0 text-white shadow-lg transform transition-transform duration-300 ease-in-out z-40 flex flex-col items-center"
    ...
    >
        <svg
            ...
            class="w-6 h-6 transition-transform duration-300 rotate-180"
            fill="none"
            stroke="currentColor"
            stroke-width="4"
...
<div class="md:hidden">
    <button
        id="mobile-menu-btn"
        class="fixed top-[8px] left-3 z-50 bg-white text-[#1EB8CD] w-11 h-11 flex items-center justify-center"
    >
