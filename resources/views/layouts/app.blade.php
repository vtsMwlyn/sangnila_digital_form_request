...
<body>
  ...
  <div
    class="min-h-screen bg-gradient-to-r from-[#B3C4DE] to-[#EAEFF6]"
    id="app-wrapper"
  >
    ...
    <main
      id="main-content"
      class="ml-72 transition-all duration-300 ease-in-out p-5 xl:p-10 min-h-[90vh]"
    >
      @yield ('content')
  ...
  <script>
    ...
    function openSidebar() {
      ...
      if (isMobile()) {
        ...
        $("#main-content, #page-navbar, #page-footer")
          .removeClass("ml-0")
          .addClass("ml-72");
      }
    }
