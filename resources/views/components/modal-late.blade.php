<x-modal name="late-modal" maxWidth="2xl">
  <div class="p-6 text-gray-800">
      ...
      <button
        @click="
          window.dispatchEvent(
            new CustomEvent('close-modal', { detail: 'late-modal' }),
          )
        "
    ...
    <p class="text-lg font-semibold mb-4 text-center">Select which balance will be reduced for total late this employee:</p>
    ...
    <div class="grid grid-cols-2 gap-5">
      <form
        method="post"
        action="{{ route('admin.late', ['mode' => 'leave']) }}"
      >
        @csrf
      ...
      <form
        method="post"
        action="{{ route('admin.late', ['mode' => 'overtime']) }}"
      >
        @csrf
