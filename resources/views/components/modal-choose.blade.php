...
<x-modal name="choose-modal" maxWidth="2xl">
  <div class="p-4">
      ...
      <button
        ...
        @click="
          window.dispatchEvent(
            new CustomEvent('close-modal', { detail: 'choose-modal' }),
          )
        "
    ...
    <div class="p-6 text-gray-800">
      <p class="text-lg font-semibold mb-4 text-center">Select which balance will be reduced for approving this employee's leave:</p>
      ...
      <div class="w-full grid grid-cols-2 gap-5">
        <form
          method="post"
          action="{{ route('admin.leave.approve', ['mode' => 'leave']) }}"
        ...
        <form
          method="post"
          action="{{ route('admin.leave.approve', ['mode' => 'overtime']) }}"
          class="w-full flex flex-col items-center"
        >
          @csrf
          <input type="hidden" name="leaveId" value="0" />
