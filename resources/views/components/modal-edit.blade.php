<x-modal name="edit-modal" maxWidth="2xl">
  <div class="p-4">
      ...
      <button
        @click="
          window.dispatchEvent(
            new CustomEvent('close-modal', { detail: 'edit-modal' }),
          )
        "
    ...
    <div class="p-6 text-gray-800 max-h-[80vh] overflow-y-auto">
      <p class="text-xl font-bold mb-4 text-left">Edit Account</p>
      <form id="editForm" method="POST" action="">
        ...
        <div class="flex gap-4">
          <div class="mb-4 w-1/2">
            <label for="Leave_Balance" class="font-semibold text-sm block mb-1"
              >Leave Balance</label
            >
            <div class="relative">
              <x-text-input
                id="Leave_Balance_Day"
                name="Leave_Balance_Day"
                type="text"
                class="w-full rounded border px-3 py-2 pr-10"
                placeholder="Enter Leave Balance in Day"
              />
              <label
        ...
        <div class="flex gap-4">
          <div class="mb-4 w-1/2">
            <label
              for="overtime_balance"
              class="font-semibold text-sm block mb-1"
              >Total Overtime</label
            >
            <div class="relative">
              <x-text-input
                id="overtime_balance_Day"
                name="overtime_balance_Day"
                type="text"
                class="w-full rounded border px-3 py-2"
                placeholder="Enter Total Overtime in Day"
              />
              <label
                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-800 focus:outline-none"
                >Days</label
          ...
          <div class="mt-6 w-1/2">
            <div class="relative">
              <x-text-input
                id="overtime_balance_Hour"
                name="overtime_balance_Hour"
                type="text"
                class="w-full rounded border px-3 py-2"
        ...
        {{-- DEPARTMENT --}}
        <div class="mb-4">
          <label for="departmentSelect" class="font-semibold text-sm block mb-1"
            >Department</label
          >
