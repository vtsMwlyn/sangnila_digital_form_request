  ...
  >
    <div class="min-h-screen flex flex-col justify-between">
      ...
      >
        ...
        >
          <img
            src="{{ asset('img/suspended_icon.webp') }}"
            alt="Account Suspended"
            class="w-32 mx-auto mb-6 opacity-90"
          />
          ...
          <div class="mb-6">
            ...
            <p class="text-sm text-gray-600 mb-1">Your account has been suspended by the administrator.</p>
            <p class="text-sm text-gray-600">This may be due to policy violations or other administrative reasons.</p>
          </div>
          ...
          <p class="text-xs text-gray-500 leading-relaxed">If you believe this is a mistake, please contact our support team for further assistance.</p>
        </div>
      </div>
